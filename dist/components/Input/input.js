...
export var Input = function (props) {
    ...
    var classes = classNames("yinyin-input-wrapper", (_a = {},
    ...
    return (React.createElement("div", { className: classes, style: style },
        prepend && React.createElement("div", { className: "yinyin-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-".concat(icon) }))),
        React.createElement("input", __assign({ className: "yinyin-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "yinyin-input-group-append" }, append)));
};
